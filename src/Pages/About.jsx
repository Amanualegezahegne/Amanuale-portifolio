            ...
            <div className="about-content">
                ...
                <div className="about-text">
                    ...
                    <div className="about-cards">
                        <div className="card">
                            <h3>Education</h3>
                            <p>B.Sc. in Software Engineering, 4th Year, Debre Birhan University
                                <br /> Have some certificates completed from udacity.
                            </p>
                        </div>
                        <div className="card">
                            <h3>Skills</h3>
                            <p>HTML, CSS, JavaScript, React, Node.js, MongoDB, Git and some basic knowledge on Python, Java programming languages.</p>
                        </div>
                        <div className="card">
                            <h3>Hobbies</h3>
